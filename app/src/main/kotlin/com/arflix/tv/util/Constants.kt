...
/**
 * Control visibility of features in this fork.
 */
object FeatureVisibility {
    const val SHOW_CLOUD_ACCOUNT = false
    const val SHOW_TRAKT_ACCOUNT = false
    const val SHOW_MDBLIST_ACCOUNT = false
    const val SHOW_HOME_SERVER = false
    const val SHOW_LIVE_TV = false
    const val SHOW_CATALOGS = false
    const val SHOW_PLUGINS = false
    const val SHOW_ADDONS = false
    const val SHOW_TELEGRAM = true
}
